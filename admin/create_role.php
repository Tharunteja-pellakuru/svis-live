  ...
  <div class="page-header">
    <div class="page-header-left">
      ...
      <div>
        ...
        <div class="page-header-title">Create Role</div>
      </div>
    </div>
  ...
  <div class="panel">
    <div class="panel-head">
      <div class="panel-head-left">
        <div class="panel-head-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
        <span class="panel-head-title">New Admin Role</span>
      </div>
    </div>

    <div class="panel-body" style="padding: 1.75rem 1.5rem;">
      <form action="save_role.php" method="POST" novalidate>

        <div class="field">
          <label class="field-label">Role Name</label>
          <div class="input-wrap">
            <input type="text" name="role_name" placeholder="e.g. Content Manager, Super Admin" required>
          </div>
        </div>
        ...
        <div class="perm-grid-dash">
          ...
          <!-- Add -->
          <label class="perm-card-dash perm-add" id="lbl-add">
            <input type="checkbox" name="permissions[]" value="add" onchange="togglePerm(this, 'lbl-add')">
            <div class="perm-check-mark"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div>
          ...
          <!-- Edit -->
          <label class="perm-card-dash perm-edit" id="lbl-edit">
            <input type="checkbox" name="permissions[]" value="edit" onchange="togglePerm(this, 'lbl-edit')">
            <div class="perm-check-mark"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div>
          ...
          <!-- Delete -->
          <label class="perm-card-dash perm-delete" id="lbl-delete">
            <input type="checkbox" name="permissions[]" value="delete" onchange="togglePerm(this, 'lbl-delete')">
            <div class="perm-check-mark"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div>
        ...
        <div style="display:flex; gap:12px;">
          <button type="submit" class="btn-primary-dash" style="flex:1; justify-content:center;">Create Role</button>
