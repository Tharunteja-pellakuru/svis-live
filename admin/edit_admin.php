...
include('../db_connect.php');
    ...
    if (!$user) {
        $_SESSION['flash_msg'] = "Admin not found";
        $_SESSION['flash_type'] = "error";
        echo "<script>window.location.href='admin_list.php';</script>"; exit;
    }
    ?>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-save:hover  { background: var(--blue-hover, #154a8a); box-shadow: 0 4px 14px rgba(26,86,160,0.32); }
    ...
    .pw-hint { font-size: 0.75rem; color: var(--text-3); margin-top: 0.4rem; font-style: italic; }
    </style>
    ...
    <div class="form-card">
        ...
        <form action="update_admin.php" method="POST" novalidate>
            ...
            <div class="field">
                ...
                <div class="pw-hint">Leave blank to keep existing password</div>
            </div>
